...
if (! empty($pageResult)) {
    foreach ($pageResult as $page) {
        ?>
         <div class="card1">
         <img class="imgp" style="-webkit-box-shadow: 5px 5px 15px 5px #000000; box-shadow: 5px 5px 15px 5px #000000; max-width:300px; width:100%; height:auto;" id="img<?php echo $page['id']; ?>" src="profiles/<?php echo $page['id'];?>/<?php echo $page['flename'];?>" alt="" style="width:100%">
    </div>
    <div class="card2">
         <h3><?php echo '<b>Name: </b>' . $page["fname"] . ' ' . $page["lname"]; ?></h3> 
         <h3>
          <?php 
...
if (($pn - 1) > 1) {
    ?>
    <a href='browse.php?page=1'><div class='page-a-link'>1</div></a>
...
for ($i = ($pn - 1); $i <= ($pn + 1); $i ++) {
    ...
    ?>
    <a href='browse.php?page=<?php echo $i; ?>'>
...
if (($totalPages - ($pn + 1)) > 0) {
    ...
    ?>
    <a href='browse.php?page=<?php echo $totalPages; ?>'><div
