...
require_once __DIR__ . '/Model/Pagination2.php';
...
<center><h2>My Shortlisted Profiles</h2></center>
<div class="mcard">
...
if (($pn - 1) > 1) {
    ?>
    <a href='myshortlists.php?page=1'><div class='page-a-link'>1</div></a>
...
for ($i = ($pn - 1); $i <= ($pn + 1); $i ++) {
    ...
    ?>
    <a href='myshortlists.php?page=<?php echo $i; ?>'>
...
if (($totalPages - ($pn + 1)) > 0) {
    ...
    ?>
    <a href='myshortlists.php?page=<?php echo $totalPages; ?>'><div
