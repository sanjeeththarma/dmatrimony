...
set_error_handler(function(int $number, string $message) {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                include 'connection.php';
                    ...
                    $query = "SELECT * FROM likes WHERE from1 = '$f' AND to1 = '$t'";

                    $result = $mysqli->query($query);

                    if ($result) {
                        if (mysqli_num_rows($result) > 0) {
                            echo '<br><br><center><font size="6">Like already sent ! <br></center><br><br>';
                        } else {
                            $sql = "INSERT INTO likes (from1, to1)
                            VALUES ('$f', '$t')";
                            
                            
                            if ($conn->query($sql) === TRUE) {
                                echo '<br><br><center><font size="5">Like send successfully ! <br></center><br><br>';
                            } else {
