...
require_once __DIR__ . '/Model/Pagination5.php';
...
<center><h2>Who liked My Profile</h2></center>
<div class="mcard">
    ...
    <div class="card2">
      ...
      if (mysqli_num_rows($resultp) > 0) {
          while($rowp = mysqli_fetch_assoc($resultp)) {
            ...
            echo '<img class="imgp" style="-webkit-box-shadow: 5px 5px 15px 5px #000000; box-shadow: 5px 5px 15px 5px #000000; width:100px; height:100px; border-radius:100%;" id="img'. $rowp['id'] . '"' . ' src="profiles/' . $rowp['id'] . '/'. $rowp['flename'] . '" alt="" style="width:100%">';
            echo '</div>';
            echo '<h3>' . $rowp["fname"] . ' ' . $rowp["lname"] . ' <img src="heart.png" style="height:30px; width:30px; position:relative; top:10px;"> likes you</h3>';
...
if (($pn - 1) > 1) {
    ?>
    <a href='likesreceived.php?page=1'><div class='page-a-link'>1</div></a>
...
for ($i = ($pn - 1); $i <= ($pn + 1); $i ++) {
    ...
    ?>
    <a href='likesreceived.php?page=<?php echo $i; ?>'>
...
if (($totalPages - ($pn + 1)) > 0) {
    ...
    ?>
    <a href='likesreceived.php?page=<?php echo $totalPages; ?>'><div
