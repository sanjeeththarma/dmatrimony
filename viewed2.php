...
require_once __DIR__ . '/Model/Pagination4.php';
  ...
  <ul class="menu">
    ...
    <li> 
      ...
      <ul>
        ...
        <li><a href="viewed2.php">My Shortlisted Profiles</a></li>
      </ul>
    </li>
    <li> 
      <!-- First Tier Drop Down -->
...
<center><h2>Who Viewed My Profile</h2></center>
<div class="mcard">
...
if (($pn - 1) > 1) {
    ?>
    <a href='viewed2.php?page=1'><div class='page-a-link'>1</div></a>
...
for ($i = ($pn - 1); $i <= ($pn + 1); $i ++) {
    ...
    ?>
    <a href='viewed2.php?page=<?php echo $i; ?>'>
...
if (($totalPages - ($pn + 1)) > 0) {
    ...
    ?>
    <a href='viewed2.php?page=<?php echo $totalPages; ?>'><div
