...
require_once __DIR__ . '/Model/Pagination6.php';
  ...
  <ul class="menu">
    ...
    <li> 
      ...
      <ul>
        ...
        <li><a href="search.php">My Shortlisted Profiles</a></li>
      </ul>
    </li>
    <li> 
      <!-- First Tier Drop Down -->
...
if (! empty($pageResult)) {
    ...
    <div class="card2">
      <?php
            ...
            echo '<img class="imgp" style="-webkit-box-shadow: 5px 5px 15px 5px #000000; box-shadow: 5px 5px 15px 5px #000000; max-width:300px; width:100%; height:auto;" id="img'. $page['id'] . '"' . ' src="profiles/' . $page['id'] . '/'. $page['flename'] . '" alt="" style="width:100%">';
            echo '</div>';
            echo '<h3><b>Name: </b>' . $page["fname"] . ' ' . $page["lname"] . '</h3>';
            $dateOfBirth = $page["bday"];
            $today = date("Y-m-d");
            ...
            echo '<br>';
                        echo '<b>Marital Status: </b>' . $page["mstatus"];
                        echo '<br>';
                        echo '<b>Religion: </b>' . $page["religion"];
                        echo '<br>';
                        echo '<b>Country: </b>' . $page["country"];
                        echo '<br>';
                        echo '<button class="button5" onclick="viewprofile(\'' . $page["id"] . '\')">View Profile</button>';
 ...
 <?php }} else {echo '<br><br><center><font size="6">No Matches Found</font></center>';} ?> 
<br><br>
 <center>
...
if (($pn - 1) > 1) {
    ?>
    <a href='search.php?page=1'><div class='page-a-link'>1</div></a>
